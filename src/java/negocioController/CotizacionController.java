...
import negocioSession.CotizacionFacade;
...
public class CotizacionController implements Serializable {
    ...
    @EJB
    private negocioSession.CotizacionFacade ejbFacade;
    ...
    public static class CotizacionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Cotizacion) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + CotizacionController.class.getName());
            }
        }
    }
}
