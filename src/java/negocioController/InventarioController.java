...
import negocioSession.InventarioFacade;
...
public class InventarioController implements Serializable {
    ...
    @EJB
    private negocioSession.InventarioFacade ejbFacade;
    ...
    public static class InventarioControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Inventario) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + InventarioController.class.getName());
            }
        }
    }
}
