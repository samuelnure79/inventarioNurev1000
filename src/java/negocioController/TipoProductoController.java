...
import negocioSession.TipoProductoFacade;
...
public class TipoProductoController implements Serializable {
    ...
    @EJB
    private negocioSession.TipoProductoFacade ejbFacade;
    ...
    public static class TipoProductoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof TipoProducto) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + TipoProductoController.class.getName());
            }
        }
    }
}
