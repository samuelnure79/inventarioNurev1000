...
import negocioSession.TransaccionFacade;
...
public class TransaccionController implements Serializable {
    ...
    @EJB
    private negocioSession.TransaccionFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Transaccion) getItems().getRowData();
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TransaccionDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
