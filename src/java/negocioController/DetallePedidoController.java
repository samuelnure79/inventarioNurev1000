...
import negocioSession.DetallePedidoFacade;
...
public class DetallePedidoController implements Serializable {
    ...
    @EJB
    private negocioSession.DetallePedidoFacade ejbFacade;
    ...
    public static class DetallePedidoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof DetallePedido) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + DetallePedidoController.class.getName());
            }
        }
    }
}
