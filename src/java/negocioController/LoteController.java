...
import negocioSession.LoteFacade;
...
public class LoteController implements Serializable {
    ...
    @EJB
    private negocioSession.LoteFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Lote) getItems().getRowData();
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("LoteDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class LoteControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Lote) {
                Lote o = (Lote) object;
                return getStringKey(o.getIdLote());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + LoteController.class.getName());
            }
        }
    }
}
